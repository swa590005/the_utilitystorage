...
/**
 * @ORM\Entity(repositoryClass=YearHeaterReadingRepository::class)
 */
class YearHeaterReading
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Heater::class, inversedBy="yearHeaterReadings")
